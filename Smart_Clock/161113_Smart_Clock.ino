...
// Define time buffer index
#define HOUR10          time_buffer[0]
#define HOUR            time_buffer[1]
#define MIN10           time_buffer[3]
#define MIN             time_buffer[4]
#define SEC10           time_buffer[6]
#define SEC             time_buffer[7]
// Define info string length
#define INFO_BUFFER_LEN     100  // Lenght of info buffer
#define TIME_BUFFER_LEN     50    // Lenght of time buffer
#define INFOMATION_BUFFER_LEN     100    // Lenght of time buffer
